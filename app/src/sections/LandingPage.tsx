    ...
    <div className="min-h-screen bg-background font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center gap-3">
              <ThemeToggle />
              <PortalButton className="bg-pp-teal hover:bg-pp-teal-600 text-white rounded-full px-5 py-2.5 text-sm font-semibold shadow-lg">
                Get Started
              </PortalButton>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-background border-t border-border animate-slide-down">
            <div className="px-4 py-4 space-y-3">
              ...
              <PortalButton className="w-full bg-pp-teal hover:bg-pp-teal-600 text-white rounded-xl px-4 py-3 text-base font-semibold shadow-lg">
                Get Started
              </PortalButton>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <PortalButton
                size="lg"
                className="bg-pp-teal hover:bg-pp-teal-600 text-white rounded-full px-8 py-6 text-base sm:text-lg font-semibold shadow-lg"
              >
                Get Started
          ...
          <div className="relative">
            ...
            <div className="relative bg-card rounded-2xl overflow-hidden shadow-2xl border border-border">
              ...
              <div className="px-6 py-4 bg-card border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <PortalButton className="bg-pp-teal hover:bg-pp-teal-600 text-white rounded-full px-6 py-2.5 text-sm font-semibold shadow-lg">
                  Try It Free
          ...
          <div className="mt-16 lg:mt-20">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col h-full rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-lg shadow-black/5">
                ...
                <PortalButton className="mt-auto w-full min-w-0 h-auto shrink whitespace-normal text-center px-4 py-4 sm:py-5 bg-pp-teal hover:bg-pp-teal-600 text-white rounded-full text-sm sm:text-base font-semibold leading-snug shadow-lg">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <PortalButton className="bg-pp-teal hover:bg-pp-teal-600 text-white rounded-lg px-6 py-3 font-medium shadow-lg shadow-pp-teal/20">
                  Get the App
                  <ChevronRightIcon size={18} className="ml-2" />
                </PortalButton>
                <Button
                  onClick={() => document.getElementById('helper-app')?.scrollIntoView({ behavior: 'smooth' })}
                  variant="outline"
      ...
      <section className="py-24 bg-pp-teal px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <PortalButton
            size="lg"
            className="bg-white text-pp-teal hover:bg-white/90 rounded-full px-10 py-6 text-lg font-semibold shadow-lg"
          >
            Get Started
            <ChevronRightIcon size={20} className="ml-2" />
          </PortalButton>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 sm:gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-black">
                ...
                <li><a href={PORTAL_URL} target="_blank" rel="noopener noreferrer" className="text-black hover:text-pp-teal-600 transition-colors">Get Started</a></li>
              </ul>
            </div>
